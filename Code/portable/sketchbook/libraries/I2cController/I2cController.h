#ifndef I2cControllerLib_h
#define I2cControllerLib_h
...
class I2cControllerLib : public Print {
	public:
		I2cControllerLib(uint8_t i2cAddr,uint8_t detectDevice=0,uint8_t backlightInverted=0);
