...
#ifndef PANEL_CFG_5Key
	// Uncomment to enable the buzzer on PortA GPA4 Not possible with PANEL_CFG_5Key On!!!!
	#define BUZZ_A4
#endif

#ifndef PANEL_CFG_ENC
// Uncomment to enable the buzzer on PortA GPA0 Not possible with PANEL_CFG_ENC On!!!! 
//#define BUZZ_A0
#endif
...
// Standard directional button bits
	...
	#define BUTTON_RIGHT	0x80
	#define BUTTON_SELECT	0x20
	#define ALL_BUTTON_BITS (BUTTON_LEFT|BUTTON_RIGHT|BUTTON_SELECT)
#endif

#ifdef PANEL_CFG_ENC
	#define ENC_CLICK		0x01
#else
